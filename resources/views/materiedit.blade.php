...
@section('body')
    ...
    <div class="col-lg-8">
        <form method="post" action="{{ url('guru/materi/' . $materi->id) }}">
            @method('put')
            @csrf
            <div class="form-group mb-3">
                ...
                <input type="text" name="nama_bab" class="form-control @error('nama_bab') is-invalid @enderror"
                    id="nama_bab" required autofocus value="{{ old('nama_bab', $materi->nama_bab) }}">
                @error('nama_bab')
            ...
            <div class="form-group mb-3">
                ...
                <input id="x" type="hidden" class="form-control @error('isi_bab') is-invalid @enderror"
                    id="isi_bab" rows="5" required name="isi_bab" value="{{ old('isi_bab', $materi->isi_bab) }}">
            ...
            <div class="form-group mb-3">
                ...
                <select name="id_quiz" class="form-control @error('id_quiz') is-invalid @enderror" id="id_quiz" required
                    value="{{ old('id_quiz', $materi->soal_1) }}">
                    @error('id_quiz')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="form-group mb-3">
                ...
                <select name="id_matpel" class="form-control @error('id_matpel') is-invalid @enderror" id="id_matpel"
                    required value="{{ old('id_matpel', $materi->nama_matpel) }}">
                    @error('id_matpel')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <button type="submit" class="btn btn-primary">Create Materi</button>
        </form>
    </div>
@endsection
